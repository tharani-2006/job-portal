    ...
    return (
        <div className='container 2xl:px-20 mx-auto my-10'>
            <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl'>
                <h2 className='text-2xl md:text-3xl lg:text-4xl font-medium mb-4'>Over 5000+ Jobs to apply</h2>
                <p className='mb-8 max-w-xl mx-auto text-sm font-light px-5'>Lorem ipsum dolor, sit amet consectetur  elit. Provident,  ipsam, molestias reiciendis quidem , porro reprehenderit. Voluptate, quis!</p>
